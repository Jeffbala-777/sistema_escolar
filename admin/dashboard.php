    ...
    <div class="content-area p-4">
        ...
        <div class="page-card p-4">
            ...
            <div class="dashboard-subtitle mb-4">
                ...
                Acesse relatórios e desempenho da unidade escolar.
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <a href="<?= base_url('admin/relatorios_turma.php') ?>" class="text-decoration-none">
                        ...
                        " onmouseover="this.style.boxShadow='0 8px 25px rgba(14, 121, 235, 0.15)'; this.style.transform='translateY(-4px)';" onmouseout="this.style.boxShadow='0 4px 15px rgba(14, 121, 235, 0.08)'; this.style.transform='translateY(0)';">
                            <div style="display: flex; align-items: center; gap: 20px; width: 100%;">
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <p class="mb-0" style="font-size: 13px; color: #6c757d; line-height: 1.5;">Central de relatórios de alunos e turmas</p>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-6">
                    <a href="<?= base_url('admin/desempenho.php') ?>" class="text-decoration-none">
                        <div class="dashboard-card p-5 border-0 h-100" style="
                            background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);
                        ...
                        " onmouseover="this.style.boxShadow='0 8px 25px rgba(40, 167, 69, 0.15)'; this.style.transform='translateY(-4px)';" onmouseout="this.style.boxShadow='0 4px 15px rgba(40, 167, 69, 0.08)'; this.style.transform='translateY(0)';">
                            <div style="display: flex; align-items: center; gap: 20px; width: 100%;">
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <p class="mb-0" style="font-size: 13px; color: #6c757d; line-height: 1.5;">Consultar desempenho geral da escola</p>
                                </div>
                            </div>
                        </div>
                    </a>
